...
import { cn } from "cn"
import vscodeIcon from "@/assets/code-stable.png"
import cursorIcon from "@/assets/brand-logo-5.svg"
...
export function CursorIcon({
  ...
  return (
    <img
      src={cursorIcon}
      alt="Cursor"
      className={cn("size-4 shrink-0 object-contain select-none rounded-[3px]", className)}
      {...props}
    />
  )
}
